...
import 'package:schoolie/screens/parent/main_parent_page.dart';

class GetMultiHelper {
  static DateTime date = DateTime.now();
  static String dateFormat = DateFormat('EEEE').format(date);
  ...
  static Future getData(
    ...
    try {
      final response = await http.post(
          "http://192.168.43.145/$schoolid/for_app/get_data/$typeOfData.php",
          body: {
            "schoolid": '$schoolid',
            "section": '$section',
            "class": '$childclass',
